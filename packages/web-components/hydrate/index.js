...
const createTime = (e, t = "") => {
 ...
 if (o !== n) {
  ...
  } else if ("key" === t) ; else if ("ref" === t) n && n(e); else {
   {
...
class ModukAccordion {
  ...
  async componentDidRender() {
    ...
    if (typeof window !== 'undefined') {
      //@ts-expect-error
      const { Accordion } = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@moduk/frontend/client')); });
  ...
  render() {
    return (hAsync(Host, { ref: (el) => {
        this.accordionEl = el;
      } }, hAsync("div", { class: "govuk-accordion", "data-module": "govuk-accordion", key: this.items.length }, this.items.map(({ heading, content, summary, key }, index) => (hAsync("div", { class: "govuk-accordion__section", key: `${key || index}-${this.items.length}` }, hAsync("div", { class: "govuk-accordion__section-header" }, hAsync("h2", { class: "govuk-accordion__section-heading" }, hAsync("span", { class: "govuk-accordion__section-button", id: `accordion-default-heading-${index}` }, heading)), summary ? hAsync("div", { class: "govuk-accordion__section-summary govuk-body", id: "accordion-with-summary-sections-summary-1" }, summary) : null), hAsync("div", { id: "accordion-default-content-1", class: "govuk-accordion__section-content", "aria-labelledby": `accordion-default-heading-${index}` }, hAsync("p", { class: "govuk-body" }, content))))))));
  }
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "moduk-accordion",
    "$members$": {
      "items": [16]
    },
    "$listeners$": undefined,
